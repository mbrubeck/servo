...
impl WebGLRenderingContextMethods for WebGLRenderingContext {
    ...
    fn TexImage2DDOM(&self,
        ...
        // Get bound TextureId
        let texture_id = match self.bound_texture_2d.get() {
        ...
        let command = DOMToTextureCommand::Attach(texture_id,
                                                  document_id,
                                                  pipeline_id.to_webrender(),
                                                  Size2D::new(512, 512));
        self.webgl_sender.send_dom_to_texture(command);
